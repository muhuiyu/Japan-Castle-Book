...
extension LocalCastleServiceIntegrationTests {
    ...
    private func overview(at index: Int) -> String {
        return [
            ...
            "五稜郭は、函館山から約６km離れた函館市のほぼ中央となる場所にある｡この場所は、ちょうど浅いすり鉢の底のように低くなっている所。この五稜郭のある周辺は、今から約150年前の江戸時代終わり頃、箱館が開港された時はたくさんの「ネコヤナギ」が生えていたようで、このため別名「柳野（やなぎの）」と呼ばれていたように当時は至る所が水はけの悪い湿地だったようだ。"
        ][index]
    }
