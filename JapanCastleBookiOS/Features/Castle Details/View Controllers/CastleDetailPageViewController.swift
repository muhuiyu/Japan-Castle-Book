...
extension CastleDetailPageViewController: UIPageViewControllerDataSource {
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        guard let currentIndex = subViewControllers.firstIndex(of: viewController as! ViewController), currentIndex > 0 else {
               return nil
           }
       ...
       func pageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController? {
           guard let currentIndex = subViewControllers.firstIndex(of: viewController as! ViewController), currentIndex < subViewControllers.count - 1 else {
               return nil
           }
           return subViewControllers[currentIndex + 1]
       }
